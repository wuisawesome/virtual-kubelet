...
type PrunePodsRequest struct {
	...
	CoreV1PodJsonsToKeep []string `protobuf:"bytes,1,rep,name=core_v1_pod_jsons_to_keep,json=coreV1PodJsonsToKeep,proto3" json:"core_v1_pod_jsons_to_keep,omitempty"`
}

func (x *PrunePodsRequest) Reset() {
	*x = PrunePodsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *PrunePodsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrunePodsRequest) ProtoMessage() {}

func (x *PrunePodsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrunePodsRequest.ProtoReflect.Descriptor instead.
func (*PrunePodsRequest) Descriptor() ([]byte, []int) {
	return file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_rawDescGZIP(), []int{4}
}

func (x *PrunePodsRequest) GetCoreV1PodJsonsToKeep() []string {
	if x != nil {
		return x.CoreV1PodJsonsToKeep
	}
	return nil
}

type PrunePodsReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *PrunePodsReply) Reset() {
	*x = PrunePodsReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *PrunePodsReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrunePodsReply) ProtoMessage() {}

func (x *PrunePodsReply) ProtoReflect() protoreflect.Message {
	mi := &file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrunePodsReply.ProtoReflect.Descriptor instead.
func (*PrunePodsReply) Descriptor() ([]byte, []int) {
	return file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetPodStatusRequest) Reset() {
	*x = GetPodStatusRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetPodStatusRequest) Descriptor() ([]byte, []int) {
	return file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_rawDescGZIP(), []int{6}
}

func (x *GetPodStatusRequest) GetCoreV1PodJson() string {
	if x != nil {
		return x.CoreV1PodJson
	}
	return ""
...
type GetPodStatusReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CoreV1PodStatusJson string `protobuf:"bytes,1,opt,name=core_v1_pod_status_json,json=coreV1PodStatusJson,proto3" json:"core_v1_pod_status_json,omitempty"`
}

func (x *GetPodStatusReply) Reset() {
	*x = GetPodStatusReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetPodStatusReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPodStatusReply) ProtoMessage() {}

func (x *GetPodStatusReply) ProtoReflect() protoreflect.Message {
	mi := &file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPodStatusReply.ProtoReflect.Descriptor instead.
func (*GetPodStatusReply) Descriptor() ([]byte, []int) {
	return file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_rawDescGZIP(), []int{7}
}

func (x *GetPodStatusReply) GetCoreV1PodStatusJson() string {
	if x != nil {
		return x.CoreV1PodStatusJson
	}
	return ""
}
...
var file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_rawDesc = []byte{
	...
	,
}
...
var file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_goTypes = []interface{}{
	...
	(*PrunePodsRequest)(nil),     // 4: PrunePodsRequest
	(*PrunePodsReply)(nil),       // 5: PrunePodsReply
	(*GetPodStatusRequest)(nil),  // 6: GetPodStatusRequest
	(*GetPodStatusReply)(nil),    // 7: GetPodStatusReply
}
var file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_depIdxs = []int32{
	...
	4, // 2: PodProvider.PrunePods:input_type -> PrunePodsRequest
	6, // 3: PodProvider.GetPodStatus:input_type -> GetPodStatusRequest
	1, // 4: PodProvider.ConfigureNode:output_type -> ConfigureNodeReply
	3, // 5: PodProvider.CreatePod:output_type -> CreatePodReply
	5, // 6: PodProvider.PrunePods:output_type -> PrunePodsReply
	7, // 7: PodProvider.GetPodStatus:output_type -> GetPodStatusReply
...
func file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrunePodsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrunePodsReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPodStatusRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cmd_virtual_kubelet_internal_provider_grpc_pod_provider_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPodStatusReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
